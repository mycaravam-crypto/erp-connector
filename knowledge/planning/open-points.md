...
| 6 | Return-channel timing | Vendor + sponsor | Iteration 2 scope. The vendor will eventually write back CI update confirmations; timing and format TBD. Design planned in [Import Definitions](/pipeline/import-definitions.md) — not started; that doc's §6 Open Decisions #4–8 are the specific sub-questions still needing a stakeholder answer. |
