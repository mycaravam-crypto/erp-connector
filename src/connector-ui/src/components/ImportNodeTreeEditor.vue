      ...
      <div class="flex-1 flex flex-col gap-2">
        <div class="flex gap-2.5 flex-wrap items-end">
          <div class="flex flex-col gap-1 min-w-32">
            <label class="text-[0.65rem] font-semibold text-text-muted uppercase tracking-wide">Source key (JSON)</label>
            <input
              type="text"
          ...
          <template v-if="node.kind === 'scalar-field'">
            <div class="flex flex-col gap-1 min-w-40">
              <label class="text-[0.65rem] font-semibold text-text-muted uppercase tracking-wide">Target column ({{ contextTable }})</label>
              <select
