...
/// registered for the requested <see cref="DataSourceType"/> (e.g. <see cref="DataSourceType.ServiceNowTableApi"/>/
/// <see cref="DataSourceType.ServiceNowSqlApi"/>, or an out-of-range value), and wherever a code path only
/// supports some source types.
/// </summary>
