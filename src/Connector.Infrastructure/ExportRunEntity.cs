...
public sealed class ExportRunEntity
{
    ...
    /// <summary>UTC time of the ERP extraction run as an ISO-8601 string (SQLite has no native DateTimeOffset).</summary>
    ...
    /// <summary>UTC time of the four-eyes release. Null if not yet released.</summary>
    public string? ReleasedAt { get; set; }

    /// <summary>Username of the operator who triggered the export.</summary>
    public string? OperatedBy { get; set; }

    /// <summary>Username of the approver who released it. Must differ from OperatedBy.</summary>
    public string? ApprovedBy { get; set; }

    /// <summary>File name of the export file on the staging path. Empty when Status is Failed.</summary>
